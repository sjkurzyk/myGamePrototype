...
gdjs.New_32sceneCode.GDfloor_95despawnerObjects1= [];
gdjs.New_32sceneCode.GDfloor_95despawnerObjects2= [];
gdjs.New_32sceneCode.GDfloor_95spawnerObjects1= [];
gdjs.New_32sceneCode.GDfloor_95spawnerObjects2= [];
...
gdjs.New_32sceneCode.conditionTrue_1.val = (gdjs.evtTools.common.mod(gdjs.evtTools.runtimeScene.getTimeFromStartInSeconds(runtimeScene), 2) == 0);
}
}if (gdjs.New_32sceneCode.condition0IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDPlayerObjects1.length ;i < len;++i) {
    ...
    gdjs.New_32sceneCode.GDPlayerObjects1[i].setX(gdjs.New_32sceneCode.GDPlayerObjects1[i].getX() + (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed"))));
}
}}
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDhighwayObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDhighwayObjects1[i].setX(gdjs.New_32sceneCode.GDhighwayObjects1[i].getX() - (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed"))));
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDhighway_95holeObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDhighway_95holeObjects1[i].setX(gdjs.New_32sceneCode.GDhighway_95holeObjects1[i].getX() - (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed"))));
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDtreesObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDtreesObjects1[i].setX(gdjs.New_32sceneCode.GDtreesObjects1[i].getX() - (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed"))));
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDbuildings_95closeObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDbuildings_95closeObjects1[i].setX(gdjs.New_32sceneCode.GDbuildings_95closeObjects1[i].getX() - (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed")) / 8));
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDbuildings_95farObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDbuildings_95farObjects1[i].setX(gdjs.New_32sceneCode.GDbuildings_95farObjects1[i].getX() - (gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().get("speed")) / 40));
}
}}
...
gdjs.New_32sceneCode.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDbuildings_95farObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDbuildings_95farObjects1[i].getX() < -(256) ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDbuildings_95farObjects1[k] = gdjs.New_32sceneCode.GDbuildings_95farObjects1[i];
        ++k;
    }
}
gdjs.New_32sceneCode.GDbuildings_95farObjects1.length = k;}if (gdjs.New_32sceneCode.condition0IsTrue_0.val) {
/* Reuse gdjs.New_32sceneCode.GDbuildings_95farObjects1 */
{for(var i = 0, len = gdjs.New_32sceneCode.GDbuildings_95farObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDbuildings_95farObjects1[i].setX(0);
}
}}
...
gdjs.New_32sceneCode.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDbuildings_95closeObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDbuildings_95closeObjects1[i].getX() < -(256) ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDbuildings_95closeObjects1[k] = gdjs.New_32sceneCode.GDbuildings_95closeObjects1[i];
        ++k;
    }
}
gdjs.New_32sceneCode.GDbuildings_95closeObjects1.length = k;}if (gdjs.New_32sceneCode.condition0IsTrue_0.val) {
/* Reuse gdjs.New_32sceneCode.GDbuildings_95closeObjects1 */
{for(var i = 0, len = gdjs.New_32sceneCode.GDbuildings_95closeObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDbuildings_95closeObjects1[i].setX(0);
}
}}
...
gdjs.New_32sceneCode.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDtreesObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDtreesObjects1[i].getX() < -(256) ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDtreesObjects1[k] = gdjs.New_32sceneCode.GDtreesObjects1[i];
        ++k;
    }
}
gdjs.New_32sceneCode.GDtreesObjects1.length = k;}if (gdjs.New_32sceneCode.condition0IsTrue_0.val) {
/* Reuse gdjs.New_32sceneCode.GDtreesObjects1 */
{for(var i = 0, len = gdjs.New_32sceneCode.GDtreesObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDtreesObjects1[i].setX(0);
}
}}
...
gdjs.New_32sceneCode.GDfloor_95despawnerObjects1.length = 0;
gdjs.New_32sceneCode.GDfloor_95despawnerObjects2.length = 0;
gdjs.New_32sceneCode.GDfloor_95spawnerObjects1.length = 0;
gdjs.New_32sceneCode.GDfloor_95spawnerObjects2.length = 0;
